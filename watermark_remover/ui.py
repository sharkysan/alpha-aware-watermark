...
def build_pipeline_config(
    ...
    width: int | float = 1,
    height: int | float = 1,
    temporal_radius: int | float = 2,
    chunk_size: int | float = 24,
    scene_threshold: float = 0.62,
    min_scene_length: int | float = 10,
    motion_compensation: bool = True,
    alpha_inpaint_threshold: float = 0.55,
    analytic_confidence_min: float = 0.28,
    residual_dilate: int | float = 3,
    neighbor_length: int | float = 10,
    ref_stride: int | float = 10,
